        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Chỉnh sửa công ty</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            <form action="/admin/company/edit/{{ $company->company_id }}" method="POST" class="card-body" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea id="company_information" name="company_information">{{ $company->company_information }}</textarea>
                        </div>
                    </div>
                </div>
