...
<section class="content">
    <div class="container-fluid">
        <div class="card">
            <form action="/admin/job/edit/{{ $job->job_id }}" method="POST" class="card-body">
                <div class="row">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="categories[]" multiple="multiple">
                                ...
                                <option value="{{ $c->category_id }}" {{ App\Helpers\Helper::SelectedCategory($job->categories, $c->category_id) }}>{{ $c->category_name }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="salary">
                                ...
                                <option value="{{ $s }}" {{ $job->salary == $s ? "selected" : "" }}>{{ $s }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="years_of_experience">
                                ...
                                <option value="{{ $e }}" {{ $job->years_of_experience == $e ? "selected" : "" }}>{{ $e }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="type_of_job">
                                ...
                                <option value="{{ $t }}" {{ $job->type_of_job == $t ? "selected" : "" }}>{{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="job_title">
                                ...
                                <option value="{{ $t }}" {{ $job->job_title == $t ? "selected" : "" }}>{{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="academic_level">
                                ...
                                <option value="{{ $t }}" {{ $job->academic_level == $t ? "selected" : "" }}>{{ $t }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group mb-3">
                            <label>Độ tuổi</label>
                            <input type="text" class="form-control" name="age" placeholder="25 - 40 tuổi" value="{{ $job->age }}">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control select2" name="gender[]" multiple="multiple">
                                <option value="Nam" {{ $job->is_male ? "selected" : "" }}>Nam</option>
                                <option value="Nữ" {{ $job->is_female ? "selected" : "" }}>Nữ</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-3">
                            ...
                            <textarea id="contact" name="contact">{{ $job->contact }}</textarea>
                        </div>
                    </div>
                </div>
